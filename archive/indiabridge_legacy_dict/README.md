# Legacy indiabridge dictionary files

These per-round CSVs (`st_cen2001.csv`, `st_cen2011.csv`) are from an abandoned
3-file design of the fuzzy-matching `indiabridge` (v2). They are **not used** by the current program: the
